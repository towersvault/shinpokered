UPDATE: This repository compiles with RGBDS v0.5.2
...
If you have different projects that require different versions of `rgbds`, it might not be convenient to install rgbds 0.5.2 globally. Instead, you can put its files in a directory within shinpokered, such as `shinpokered/rgbds-0.5.2/`. Then specify it when you run `make`:
